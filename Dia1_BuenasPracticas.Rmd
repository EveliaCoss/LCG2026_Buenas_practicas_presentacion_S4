...
4. Planifique los errores (**Programación defensiva**) 🚩
...
## 📚 Actividad 1: Miniresumen personal + foto para tu repositorio
...
```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics("figures/step1_newrepository.png")
```

---

### 2. Seleccionar la configuración y dar clic en crear repositorio

```{r, echo=FALSE, out.width='80%', fig.align='center'}
knitr::include_graphics("figures/step2_config.png")
```

---

### 3. Da clic en el lapiz (✏️) para editar el *README.md*

```{r, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("figures/step3_README.png")
```
...
```{r, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("figures/step4_README_github.png")
```

.left[.footnote[.black[
Imagen tomada de: [GitHub Profile README Generator](https://rahuldkjain.github.io/gh-profile-readme-generator/)
]]]


---

## 📚 Actividad 2: Crear un sitio de Páginas de GitHub (nuestro dominio)

1. Crear un repositorio con el mismo nombre de usuario colocando: <user>.github.io o <organization>.github.io.

```{r, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("figures/step1_dominio.png")
```

2. Configura el repositorio como Público.

3. Agrega un README (opcional).

4. Haz clic en Create repository (Crear repositorio).

.left[.footnote[.black[
Imagen tomada de: [GitHub pages](https://docs.github.com/es/pages/getting-started-with-github-pages/creating-a-github-pages-site)
]]]
...
Traer para la Próxima clase: **19 de febrero, 2026**, vamos a crear nuestra página web empleando GitHub pages, por lo que deben traer:

.pull-left[
1. Sincronizar su GitHub con Rstudio, revisar el material de [Conectar a GitHub con SSH](https://eveliacoss.github.io/Workshop_GitGithub2025/Parte1.html).

2. Traer una foto y su miniresumen para crear su página web con GitHub pages
]

.pull-right[
```{r, echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics("figures/EveliaCoss_webpage.jpg")
```
]
